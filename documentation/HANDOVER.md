...
difference exactly 0 on both. `carcomposition_mockup` is NOT seeded: its
coefficients are generated by a tool, and seeding it would be seeding invented
numbers with invented numbers.
